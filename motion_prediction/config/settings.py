...
DISPLAY_LAG_SEC = 0.5           # Display lag behind physics (seconds)
...
SPEED_HOLD_SEC = 13.0            # Hold GPS speed duration (seconds)
...
CONFIDENCE_DECAY_PER_SEC = 0.85 # Confidence decay rate
